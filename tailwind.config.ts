...
const config = {
  ...
  theme: {
    ...
    extend: {
      ...
      typography: {
        terms: {
          header: "text-3xl font-bold text-white mb-4",
          subheader:
            "text-xl font-semibold text-white mb-4 pb-2 border-b border-gray-700",
          content: "text-gray-300 mb-4",
          subsection: "p-4 bg-gray-850 rounded-lg mb-6",
          bullet: "text-gray-300 mb-2 pl-8",
        },
      },
      spacing: {
        4.5: "1.125rem",
