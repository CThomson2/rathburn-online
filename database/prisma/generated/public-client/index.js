...
const config = {
  ...
  "inlineSchemaHash": "b683524dd1fa242824ef40af94a4066473ea7cd6308b66784d3258d19fe2ac60",
  "copyEngine": true
}
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "prisma/generated/public-client",
...
path.join(process.cwd(), "prisma/generated/public-client/libquery_engine-darwin-arm64.dylib.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "prisma/generated/public-client/schema.prisma")
