    ...
    return withDatabase(async (db) => {
      ...
      switch (tx_type) {
        case "intake":
          ...
          if (!delivery_id) {
            throw new Error(
              "delivery_id is required for 'intake' transactions."
            );
          }
          if (drum_id || repro_id) {
            throw new Error(
        ...
        case "processed":
          ...
          if (!drum_id) {
            throw new Error(
              "drum_id is required for 'processed' transactions."
            );
          }
          if (!process_id) {
            throw new Error(
        ...
        case "failed":
          ...
          if (!process_id) {
            throw new Error(
              "process_id is required for 'failed' transactions."
            );
          }
        ...
        case "lost":
          ...
          if (!drum_id) {
            throw new Error(
              `drum_id is required for '${tx_type}' transactions.`
            );
          }
