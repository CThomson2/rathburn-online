...
'import/no-restricted-paths': [
    'error',
    {
        zones: [
            ...
            // eg. /features/discussions should not import from /features/comments, etc.
            {
...
'import/no-restricted-paths': [
    ...
    zones: [
        ...
        // e.g. /app can import from /features but not the other way around
        {
            target: './features',
            from: './app',
        },

        // e.g /features and /app can import from these shared modules but not the other way around
        {
            target: [
                './components',
                './hooks',
